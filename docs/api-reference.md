...
SDK adapters, or CLI. It covers the v1.26.0 surface described below.
...
If neither is supplied, v1.26.0 resolves a default session: an explicit id and
...
Accept one JSON payload and return one generated record ID. In v1.26.0, this
...
The `audit` command is a reserved, planned stub in v1.26.0. It does not expose
...
[upgrade guide](upgrading-1.26.0.md) for schemas, supported inputs and limits.

*This reference covers TokenPak v1.26.0.*
