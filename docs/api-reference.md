...
SDK adapters, or CLI. It covers the v1.24.0 surface described below.
...
If neither is supplied, v1.24.0 resolves a default session: an explicit id and
...
Accept one JSON payload and return one generated record ID. In v1.24.0, this
...
The `audit` command is a reserved, planned stub in v1.24.0. It does not expose
...
*This reference covers TokenPak v1.24.0.*
