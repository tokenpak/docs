...
This page tracks current limitations of the **OSS beta** (`pip install tokenpak`, v1.11.1). The intent is **beta honesty**: if a documented capability isn't shipping the way the rest of the docs imply, it shows up here.
