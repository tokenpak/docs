...
!!! note "OSS beta"
    These docs describe the **OSS beta** of TokenPak (`pip install tokenpak`, currently **v1.10.0**, Apache 2.0). Anything not listed here is not part of the beta surface. See [Known Issues](known-issues.md) for current limitations.
