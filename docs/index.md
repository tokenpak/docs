...
!!! note "v1.23.0"
    ...
    [Docker guide](DOCKER.md) describe TokenPak **v1.23.0**, the currently
...
|---------|-----------------|
| [Installation](installation.md)            | Older-release installation guidance; use the Quick Start for v1.23.0 |
