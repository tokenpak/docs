...
!!! note "v1.25.1"
    ...
    [Docker guide](DOCKER.md) describe TokenPak **v1.25.1**, the currently
...
|---------|-----------------|
| [Installation](installation.md)            | Older-release installation guidance; use the Quick Start for v1.25.1 |
